...
import { checkoutBooking } from "@/lib/storage";
...
export default function CheckoutScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await checkoutBooking(bookingId, parseInt(odometer), fuel);
  ...
  return (
    ...
    >
      ...
      <ThemedText style={[styles.subtitle, { color: theme.textSecondary }]}>
        Record the vehicle condition before your trip
      </ThemedText>
      ...
      >
        ...
        >
          <ThemedText style={[styles.infoText, { color: theme.primary }]}>
            Please confirm you have picked up the car keys from the designated location.
          </ThemedText>
        </View>
      </View>
